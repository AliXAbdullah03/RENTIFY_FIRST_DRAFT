...
export const properties: Property[] = [
  {
    id: 'prop-1',
    title: 'Modern Downtown Apartment in BGC',
  ...
  {
    id: 'prop-2',
    title: 'Private Room in Angeles City',
  ...
  {
    id: 'prop-3',
    title: 'Affordable Bedspace for Rent in Cebu',
  ...
  {
    id: 'prop-4',
    title: 'Spacious Commercial Space in Makati',
  ...
  {
    id: 'prop-5',
    title: 'Unfurnished Studio Apartment in QC',
